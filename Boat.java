...
public class Boat extends Location {
    ...
    public void loseItem(String input, Location location, ArrayList<Item> inventory) {
        ...
        if(input.equals("shoot") || input.equals("shoot arrow")) {
            ...
            if(itemName.equals("jar") && Main.isItemHere("gold", inventory)) {
                System.out.println("Your jar and gold splash into the lake next to the boat and sinks to the bottom, never to be found\nagain.");
                ...
                System.out.println("Your " + itemName + " splashes into the lake next to the boat and sinks to the bottom, never to be found again.");
