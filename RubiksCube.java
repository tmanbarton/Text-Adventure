    ...
    public static void findTurn(char[][] cube, String input) {
        ...
        for(int i = 0; i < commands.length; i++) {
            ...
            if(input.equalsIgnoreCase("help") || input.equalsIgnoreCase("h")) {
                ...
                ScrambleGenerator.printScramble(algorithm);
                System.out.println();
                ...
                findTurn(cube, algorithm);
            }
            else if(commands[i].equalsIgnoreCase("u") || commands[i].equalsIgnoreCase("u'") || commands[i].equalsIgnoreCase("u2"))
                upTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("f") || commands[i].equalsIgnoreCase("f'") || commands[i].equalsIgnoreCase("f2"))
                frontTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("r") || commands[i].equalsIgnoreCase("r'") || commands[i].equalsIgnoreCase("r2"))
                rightTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("b") || commands[i].equalsIgnoreCase("b'") || commands[i].equalsIgnoreCase("b2"))
                backTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("l") || commands[i].equalsIgnoreCase("l'") || commands[i].equalsIgnoreCase("l2"))
                leftTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("d") || commands[i].equalsIgnoreCase("d'") || commands[i].equalsIgnoreCase("d2"))
                downTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("m") || commands[i].equalsIgnoreCase("m'") || commands[i].equalsIgnoreCase("m2"))
                middleTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("e") || commands[i].equalsIgnoreCase("e'") || commands[i].equalsIgnoreCase("e2"))
                equatorialTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("s") || commands[i].equalsIgnoreCase("s'") || commands[i].equalsIgnoreCase("s2"))
                standingTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("x") || commands[i].equalsIgnoreCase("x'") || commands[i].equalsIgnoreCase("x2"))
                xCubeTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("y") || commands[i].equalsIgnoreCase("y'") || commands[i].equalsIgnoreCase("y2"))
                yCubeTurn(cube, commands[i]);
            else if(commands[i].equalsIgnoreCase("z") || commands[i].equalsIgnoreCase("z'") || commands[i].equalsIgnoreCase("z2"))
                zCubeTurn(cube, commands[i]);
            else if(i > 0 && commands[i].equalsIgnoreCase("quit") || commands[i].equalsIgnoreCase("q") ||
                    commands[i].equalsIgnoreCase("help") || commands[i].equalsIgnoreCase("h") || commands[i].equalsIgnoreCase("scramble")) {
